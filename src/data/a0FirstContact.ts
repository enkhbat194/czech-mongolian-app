...
export const a0FirstContactMicroLessons: A0MicroLesson[] = [
  ...
  },
  {
    ...
    instructions: {
      a0c0008: 'být нь “байх” гэсэн суурь үйл үг. Энэ хичээлд Jmenuji se хэлбэрийг бэлнээр нь ашиглана.',
      a0c0009: 'já = би.',
  ...
  },
  {
    ...
    instructions: {
      ...
      a0c0017: 'Dobře. = Сайн.',
      a0c0018: 'Špatně. = Муу.',
      a0c0019: 'Odkud? = Хаанаас? Энэ хичээлд Odkud jste? гэсэн бүтнээр нь сонсоно.',
  ...
  },
  {
    ...
    cardIds: ['a0c0022', 'a0c0141', 'a0c0326', 'a0c0327'],
    instructions: {
