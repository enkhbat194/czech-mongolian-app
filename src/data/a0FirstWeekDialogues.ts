...
export const a0FirstWeekFinalDialogue: DialogueScenario = {
  ...
  steps:[
    ...
    { id:'a15final-d6', speaker:'Нөгөө хүн', staffCzech:'Kam jdete?', staffMn:'Та хаашаа явж байна?', promptMn:'Та буудал хаана байгааг асуугаарай.', choices:choices([['a','Prosím, kde je zastávka?','Уучлаарай, буудал хаана байна?'],['b','Bolí mě hlava.','Миний толгой өвдөж байна.'],['c','Nejsem v pořádku.','Би зүгээр биш байна.']]), correctId:'a', feedbackMn:'Чиглэл асуухдаа kde je zastávka? гэж асууна.' },
    ...
    { id:'a15final-d9', speaker:'Дэлгүүр', staffCzech:'Platíte kartou?', staffMn:'Та картаар төлөх үү?', promptMn:'Та үнэ асуугаад картаар төлөхөө хэлээрэй.', choices:choices([['a','Kolik to stojí? Platím kartou.','Энэ хэд вэ? Би картаар төлнө.'],['b','Je mi zima.','Би даарч байна.'],['c','Mám rodinu.','Би гэр бүлтэй.']]), correctId:'a', feedbackMn:'Үнэ болон төлбөр дээр Kolik to stojí? Platím kartou. гэж хэлж болно.' },
    { id:'a15final-d10', speaker:'Байр', staffCzech:'Jaký problém?', staffMn:'Ямар асуудал вэ?', promptMn:'Та түлхүүр байхгүй, ус гарахгүй байгааг хэлээрэй.', choices:choices([['a','Je problém. Nemám klíč. Neteče voda.','Асуудал байна. Надад түлхүүр байхгүй. Ус гарахгүй байна.'],['b','Prší.','Бороо орж байна.'],['c','Mám děti.','Би хүүхдүүдтэй.']]), correctId:'a', feedbackMn:'Байрны асуудал дээр хэд хэдэн богино өгүүлбэрийг дараалуулж хэлж болно.' },
    ...
    { id:'a15final-d12', speaker:'Нөгөө хүн', staffCzech:'Co se stalo?', staffMn:'Юу болсон бэ?', promptMn:'Та яаралтай үед зүгээр биш байгаагаа хэлж эмч дуудаж өгөхийг хүсээрэй.', choices:choices([['a','Nejsem v pořádku. Zavolejte prosím doktora.','Би зүгээр биш байна. Эмч дуудаж өгнө үү.'],['b','Účtenku, prosím.','Баримт өгнө үү.'],['c','Dnes je teplo.','Өнөөдөр дулаахан байна.']]), correctId:'a', feedbackMn:'Аюулгүй байдлын хичээлийн гол хэллэгийг дахин хэрэглэж байна.' },
    { id:'a15final-d13', speaker:'Нөгөө хүн', staffCzech:'Informace je dlouhá.', staffMn:'Мэдээлэл урт байна.', promptMn:'Та дахин хэлүүлж, бичүүлж, SMS хүсээрэй.', choices:choices([['a','Ještě jednou, prosím. Napište mi to, prosím. Pošlete mi SMS, prosím.','Дахиад нэг удаа хэлнэ үү. Үүнийг надад бичээд өгнө үү. Надад SMS явуулна уу.'],['b','Potřebuji čepici.','Надад малгай хэрэгтэй.'],['c','Jsem nový.','Би шинэ хүн.']]), correctId:'a', feedbackMn:'Ойлгохгүй үед давтуулах, бичүүлэх, SMS хүсэх гурвыг дараалуулж ашиглаж болно.' },
