...
export const a0FoodMicroLessons: A0MicroLesson[] = [
  {
    ...
    instructions:{
      a0c0105:'menu = цэс. Кафе, ресторан дээр хоол/ундааны жагсаалт гэсэн утгаар ойлгоно.',
      a0c0106:'Menu, prosím. = Цэс өгнө үү. Кафед цэс хүсэхдээ ингэж богино, эелдгээр хэлж болно.',
  ...
  {
    id:'a0-7-c', titleMn:'3/4 — Энд үү, авч явах уу?', canDoMn:'Ажилтны “энд үү, авч явах уу?” асуултыг ойлгож, авч явахаа хэлж чадна.',
