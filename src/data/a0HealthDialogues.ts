...
export const a0HealthMicroDialogues: Record<string, DialogueScenario> = {
  ...
  'a0-10-b': {
    ...
    steps:[
      { id:'a10b-d1', speaker:'Эмийн санч', staffCzech:'Máte teplotu?', staffMn:'Та халуурч байна уу?', promptMn:'Та халуурч байгаагаа хэлээрэй.', choices:choices([['a','Mám teplotu.','Би халуурч байна.'],['b','Mám klíč.','Надад түлхүүр байна.'],['c','Mám směnu.','Би ээлжтэй.']]), correctId:'a', feedbackMn:'Халуурч байвал Mám teplotu. гэж хэлнэ.' },
      { id:'a10b-d2', speaker:'Эмийн санч', staffCzech:'Tady je lék.', staffMn:'Энэ эм байна.', promptMn:'Та яаж уухыг асуугаарай.', choices:choices([['a','Jak to mám brát?','Үүнийг яаж уух вэ?'],['b','Kolik je hodin?','Цаг хэд болж байна?'],['c','Neteče voda.','Ус гарахгүй байна.']]), correctId:'a', feedbackMn:'Эмийн зааврыг Jak to mám brát? гэж асууна.' },
    ],
  },
  'a0-10-c': {
  ...
  'a0-10-d': {
    ...
    steps:[
      { id:'a10d-d1', speaker:'Эмийн санч', staffCzech:'Tady je lék.', staffMn:'Энэ эм байна.', promptMn:'Та үүнийг яаж уухыг асуугаарай.', choices:choices([['a','Jak to mám brát?','Үүнийг яаж уух вэ?'],['b','Bolí mě v krku.','Миний хоолой өвдөж байна.'],['c','To je drahé.','Энэ үнэтэй байна.']]), correctId:'a', feedbackMn:'Эм хэрэглэх зааврыг Jak to mám brát? гэж асууна.' },
      { id:'a10d-d2', speaker:'Эмийн санч', staffCzech:'Jednou denně.', staffMn:'Өдөрт нэг удаа.', promptMn:'Та дахин хэлүүлэх хүсэлт тавиарай.', choices:choices([['a','Ještě jednou, prosím.','Дахиад нэг удаа хэлнэ үү.'],['b','Platím kartou.','Би картаар төлнө.'],['c','Mám klíč.','Надад түлхүүр байна.']]), correctId:'a', feedbackMn:'Ойлгохгүй үед Ještě jednou, prosím. гэж хэлж болно.' },
    ],
  },
};
...
export const a0HealthFinalDialogue: DialogueScenario = {
  ...
  steps:[
    ...
    { id:'a10final-d6', speaker:'Эмийн санч', staffCzech:'Ano. Tady je lék.', staffMn:'Тийм. Энэ эм байна.', promptMn:'Та эмийг яаж уухыг асуугаарай.', choices:choices([['a','Jak to mám brát?','Үүнийг яаж уух вэ?'],['b','Kolik to stojí?','Энэ хэд вэ?'],['c','Mám čas.','Би завтай.']]), correctId:'a', feedbackMn:'Эмийн зааврыг Jak to mám brát? гэж асууна.' },
    ...
    { id:'a10final-d8', speaker:'Эмийн санч', staffCzech:'Jednou denně.', staffMn:'Өдөрт нэг удаа.', promptMn:'Та бичиж өгөхийг хүсээд талархаарай.', choices:choices([['a','Napište mi to, prosím. Děkuji.','Үүнийг надад бичээд өгнө үү. Баярлалаа.'],['b','Účtenku, prosím.','Баримт өгнө үү.'],['c','Neteče voda.','Ус гарахгүй байна.']]), correctId:'a', feedbackMn:'Эмийн зааврыг мартуулахгүйн тулд Napište mi to, prosím. гэж хүсэж болно.' },
  ],
};
