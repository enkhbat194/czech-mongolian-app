...
export const a0HomeMicroDialogues: Record<string, DialogueScenario> = {
  'a0-9-a': {
    ...
    steps:[
      { id:'a09a-d1', speaker:'Ажилтан', staffCzech:'Máte klíč?', staffMn:'Түлхүүр байгаа юу?', promptMn:'Та түлхүүртэйгээ хэлээрэй.', choices:choices([['a','Mám klíč.','Надад түлхүүр байна.'],['b','Je zima.','Хүйтэн байна.'],['c','Bolí mě hlava.','Толгой өвдөж байна.']]), correctId:'a', feedbackMn:'Түлхүүртэй бол Mám klíč. гэж хэлнэ.' },
      { id:'a09a-d2', speaker:'Ажилтан', staffCzech:'Dobře. Pokoj je tady.', staffMn:'За. Өрөө энд байна.', promptMn:'Та ойлгосноо талархаж хариулаарай.', choices:choices([['a','Děkuji.','Баярлалаа.'],['b','Tašku, prosím.','Уут өгнө үү.'],['c','Slyším vás.','Таныг сонсож байна.']]), correctId:'a', feedbackMn:'Тусламж авсны дараа Děkuji. гэж хэлнэ.' },
    ],
  },
  'a0-9-b': {
    id:'a0-9-b-dialogue', titleMn:'Богино яриа — түлхүүр байхгүй', contextMn:'Та байранд асуудалтай, түлхүүргүй байна.',
    steps:[
      { id:'a09b-d1', speaker:'Ажилтан', staffCzech:'Jaký problém?', staffMn:'Ямар асуудал вэ?', promptMn:'Та түлхүүр байхгүйгээ хэлээрэй.', choices:choices([['a','Nemám klíč.','Надад түлхүүр байхгүй.'],['b','Mám klíč.','Надад түлхүүр байна.'],['c','Platím kartou.','Картаар төлнө.']]), correctId:'a', feedbackMn:'Түлхүүргүй бол Nemám klíč. гэж хэлнэ.' },
  ...
  'a0-9-c': {
    ...
    steps:[
      { id:'a09c-d1', speaker:'Ажилтан', staffCzech:'Jaký problém?', staffMn:'Ямар асуудал вэ?', promptMn:'Та ус гарахгүй байгааг хэлээрэй.', choices:choices([['a','Neteče voda.','Ус гарахгүй байна.'],['b','Je zima.','Хүйтэн байна.'],['c','Slyším vás.','Таныг сонсож байна.']]), correctId:'a', feedbackMn:'Ус гарахгүй бол Neteče voda. гэж хэлнэ.' },
      { id:'a09c-d2', speaker:'Ажилтан', staffCzech:'Kde je problém?', staffMn:'Асуудал хаана байна?', promptMn:'Та энд гэж хариулаарай.', choices:choices([['a','Tady.','Энд.'],['b','Dobrý den.','Сайн байна уу.'],['c','Jak to mám brát?','Энэ эмийг яаж хэрэглэх вэ?']]), correctId:'a', feedbackMn:'Асуудлын газрыг Tady. гэж заана.' },
    ],
  },
  'a0-9-d': {
    ...
    steps:[
      ...
      { id:'a09d-d2', speaker:'Ажилтан', staffCzech:'Dobře. Ukážu vám.', staffMn:'За. Би танд үзүүлье.', promptMn:'Та талархаарай.', choices:choices([['a','Děkuji.','Баярлалаа.'],['b','Bolí mě břicho.','Гэдэс өвдөж байна.'],['c','Pošlete mi SMS, prosím.','Надад SMS явуулна уу.']]), correctId:'a', feedbackMn:'Děkuji. = Баярлалаа.' },
    ],
  },
};
...
export const a0HomeFinalDialogue: DialogueScenario = {
  ...
  steps:[
    { id:'a09final-d1', speaker:'Ажилтан', staffCzech:'Dobrý den.', staffMn:'Сайн байна уу.', promptMn:'Та мэндлээд нэрээ хэлээрэй.', choices:choices([['a','Dobrý den. Jmenuji se {userName}.','Сайн байна уу. Намайг {userName} гэдэг.'],['b','Dobrý den. Menu, prosím.','Сайн байна уу. Цэс өгнө үү.'],['c','Na shledanou.','Баяртай.']]), correctId:'a', feedbackMn:'Байр дээр ч мэндлээд нэрээ хэлэх хэллэг давтагдана.' },
    { id:'a09final-d2', speaker:'Ажилтан', staffCzech:'Mluvíte česky?', staffMn:'Та чехээр ярьдаг уу?', promptMn:'Та ойлгоход хэцүү байвал удаан ярихыг хүсээрэй.', choices:choices([['a','Nerozumím. Mluvte prosím pomalu.','Би ойлгохгүй байна. Удаан ярина уу.'],['b','Platím kartou.','Картаар төлнө.'],['c','Dám si kávu.','Кофе авъя.']]), correctId:'a', feedbackMn:'Ойлгохгүй үед өмнөх хичээлийн Nerozumím. Mluvte prosím pomalu. дахин хэрэглэнэ.' },
    ...
    { id:'a09final-d4', speaker:'Ажилтан', staffCzech:'Máte klíč?', staffMn:'Түлхүүр байгаа юу?', promptMn:'Та түлхүүр байхгүйгээ хэлээрэй.', choices:choices([['a','Nemám klíč.','Надад түлхүүр байхгүй.'],['b','Mám klíč.','Надад түлхүүр байна.'],['c','Mám teplotu.','Халуурч байна.']]), correctId:'a', feedbackMn:'Түлхүүргүй бол Nemám klíč. гэж хэлнэ.' },
