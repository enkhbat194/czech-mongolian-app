...
export const a0HomeFinalDialogue: DialogueScenario = {
  ...
  steps:[
    ...
    { id:'a09final-d6', speaker:'Ажилтан', staffCzech:'Voda?', staffMn:'Ус уу?', promptMn:'Та ус гарахгүй байгааг хэлээрэй.', choices:choices([['a','Neteče voda.','Ус гарахгүй байна.'],['b','Potřebuji vodu.','Надад ус хэрэгтэй.'],['c','Chci vodu.','Би ус хүсэж байна.']]), correctId:'a', feedbackMn:'Усны асуудал бол Neteče voda.' },
    ...
    { id:'a09final-d8', speaker:'Ажилтан', staffCzech:'Dobře. Ukážu vám.', staffMn:'За. Би танд үзүүлж өгнө.', promptMn:'Та талархаад яриаг хаагаарай.', choices:choices([['a','Děkuji. Na shledanou.','Баярлалаа. Баяртай.'],['b','Účtenku, prosím.','Баримт өгнө үү.'],['c','S sebou, prosím.','Авч явъя.']]), correctId:'a', feedbackMn:'Děkuji. Na shledanou. гэж яриаг хаана.' },
  ],
};
