...
export const a0LocationMicroDialogues: Record<string, DialogueScenario> = {
  'a0-3-a': {
    ...
    steps: [
      { id:'a03a-d1', speaker:'Ажилтан', staffCzech:'Dobrý den.', staffMn:'Сайн байна уу.', promptMn:'Та ариун цэврийн өрөө хаана байгааг эелдгээр асуугаарай.', choices:choices([['a','Prosím, kde je toaleta?','Уучлаарай, ариун цэврийн өрөө хаана байна?'],['b','Kde je lékárna?','Эмийн сан хаана байна?'],['c','Na shledanou.','Баяртай.']]), correctId:'a', feedbackMn:'Prosím, kde je toaleta? = Уучлаарай, ариун цэврийн өрөө хаана байна?' },
  ...
  'a0-3-b': {
    ...
    steps: [
      { id:'a03b-d1', speaker:'Ажилтан', staffCzech:'Hledáte nádraží?', staffMn:'Та галт тэрэгний буудал хайж байна уу?', promptMn:'Та газрын зураг дээрх хоёр сонголтын аль нь болохыг асуугаарай.', choices:choices([['a','Tady, nebo tam?','Энд үү, тэнд үү?'],['b','Kde je obchod?','Дэлгүүр хаана байна?'],['c','Kde je lékárna?','Эмийн сан хаана байна?']]), correctId:'a', feedbackMn:'Tady, nebo tam? = Энд үү, тэнд үү?' },
  ...
  'a0-3-c': {
    ...
    steps: [
      { id:'a03c-d1', speaker:'Ажилтан', staffCzech:'Dobrý den. Co potřebujete?', staffMn:'Сайн байна уу. Танд юу хэрэгтэй вэ?', promptMn:'Та дэлгүүр хаана байгааг асуугаарай.', choices:choices([['a','Kde je obchod?','Дэлгүүр хаана байна?'],['b','Prosím, kde je toaleta?','Уучлаарай, ариун цэврийн өрөө хаана байна?'],['c','Kde je lékárna?','Эмийн сан хаана байна?']]), correctId:'a', feedbackMn:'Kde je obchod? = Дэлгүүр хаана байна?' },
  ...
  'a0-3-d': {
    ...
    steps: [
      { id:'a03d-d1', speaker:'Ажилтан', staffCzech:'Dobrý den. Co potřebujete?', staffMn:'Сайн байна уу. Танд юу хэрэгтэй вэ?', promptMn:'Та эмийн сан хаана байгааг асуугаарай.', choices:choices([['a','Kde je lékárna?','Эмийн сан хаана байна?'],['b','Kde je obchod?','Дэлгүүр хаана байна?'],['c','Tady, nebo tam?','Энд үү, тэнд үү?']]), correctId:'a', feedbackMn:'Kde je lékárna? = Эмийн сан хаана байна?' },
      { id:'a03d-d2', speaker:'Ажилтан', staffCzech:'Lékárna je tady.', staffMn:'Эмийн сан энд байна.', promptMn:'Та мэдээллийг ойлгосон бол талархаарай.', choices:choices([['a','Děkuji.','Баярлалаа.'],['b','Nerozumím.','Би ойлгохгүй байна.'],['c','Kde je obchod?','Дэлгүүр хаана байна?']]), correctId:'a', feedbackMn:'Lékárna je tady. = Эмийн сан энд байна.' },
    ],
  },
};
...
export const a0LocationFinalDialogue: DialogueScenario = {
  ...
  steps: [
    ...
    { id:'a03final-d2', speaker:'Мэдээллийн ажилтан', staffCzech:'Co potřebujete?', staffMn:'Танд юу хэрэгтэй вэ?', promptMn:'Та эмийн сан хаана байгааг эелдгээр асуугаарай.', choices:choices([['a','Kde je lékárna?','Эмийн сан хаана байна?'],['b','Prosím, kde je toaleta?','Уучлаарай, ариун цэврийн өрөө хаана байна?'],['c','Nemám peníze.','Надад мөнгө байхгүй.']]), correctId:'a', feedbackMn:'Kde je lékárna? = Эмийн сан хаана байна?' },
    { id:'a03final-d3', speaker:'Мэдээллийн ажилтан', staffCzech:'Lékárna je tam.', staffMn:'Эмийн сан тэнд байна.', promptMn:'Та тэнд үү гэдгийг баталгаажуулаарай.', choices:choices([['a','Tam?','Тэнд үү?'],['b','Tady?','Энд үү?'],['c','Kde je obchod?','Дэлгүүр хаана байна?']]), correctId:'a', feedbackMn:'Сонссон байрлалаа богиноор давтаж баталгаажуулж болно.' },
