...
export const a0PeopleMicroDialogues: Record<string, DialogueScenario> = {
  ...
  'a0-12-b': {
    ...
    steps:[
      { id:'a12b-d1', speaker:'Нөгөө хүн', staffCzech:'Máte dítě?', staffMn:'Та нэг хүүхэдтэй юу?', promptMn:'Та нэг хүүхэдтэйгээ хэлээрэй.', choices:choices([['a','Mám dítě.','Би хүүхэдтэй.'],['b','Mám děti.','Би хүүхдүүдтэй.'],['c','Nemám klíč.','Надад түлхүүр байхгүй.']]), correctId:'a', feedbackMn:'Нэг хүүхэдтэй бол Mám dítě. гэж хэлнэ.' },
      { id:'a12b-d2', speaker:'Нөгөө хүн', staffCzech:'Máte děti?', staffMn:'Та хүүхдүүдтэй юу?', promptMn:'Та хүүхдүүдтэйгээ хэлээрэй.', choices:choices([['a','Ano, mám děti.','Тийм, би хүүхдүүдтэй.'],['b','Mám teplotu.','Би халуурч байна.'],['c','Mám čas.','Би завтай.']]), correctId:'a', feedbackMn:'Олон хүүхэдтэй бол Ano, mám děti. гэж хэлнэ.' },
    ],
  },
  'a0-12-c': {
    ...
    steps:[
      ...
      { id:'a12c-d2', speaker:'Нөгөө хүн', staffCzech:'Jsou děti tady?', staffMn:'Хүүхдүүд энд байгаа юу?', promptMn:'Та хүүхдүүдтэйгээ байгаагаа хэлээрэй.', choices:choices([['a','Ano, mám děti tady.','Тийм, хүүхдүүд маань энд байна.'],['b','Sněží.','Цас орж байна.'],['c','Zavolejte prosím policii.','Цагдаа дуудаж өгнө үү.']]), correctId:'a', feedbackMn:'Гэр бүлийн тухай ярианд өмнөх děti үг бодит асуултад орж байна.' },
    ],
  },
  'a0-12-d': {
    ...
    steps:[
      ...
      { id:'a12d-d2', speaker:'Нөгөө хүн', staffCzech:'Jste tady sama, nebo s rodinou?', staffMn:'Та энд ганцаараа юу, гэр бүлтэйгээ юу?', promptMn:'Эмэгтэй хүн өөрийн тухай ганцаараа байгаагаа хэлнэ.', choices:choices([['a','Ano, jsem tady sama.','Тийм, би энд ганцаараа байна.'],['b','Ano, jsem tady sám.','Тийм, би энд ганцаараа байна.'],['c','Mám problém.','Надад асуудал байна.']]), correctId:'a', feedbackMn:'Эмэгтэй хүн Ano, jsem tady sama. гэж хэлж болно.' },
    ],
  },
};
...
export const a0PeopleFinalDialogue: DialogueScenario = {
  ...
  steps:[
    ...
    { id:'a12final-d6', speaker:'Нөгөө хүн', staffCzech:'Máte děti?', staffMn:'Та хүүхдүүдтэй юу?', promptMn:'Та хүүхдүүдтэйгээ хэлээрэй.', choices:choices([['a','Ano, mám děti.','Тийм, би хүүхдүүдтэй.'],['b','Prší.','Бороо орж байна.'],['c','Je problém.','Асуудал байна.']]), correctId:'a', feedbackMn:'Олон хүүхэдтэй бол Mám děti. гэж хэлнэ.' },
