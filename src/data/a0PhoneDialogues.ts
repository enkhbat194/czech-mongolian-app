...
export const a0PhoneMicroDialogues: Record<string, DialogueScenario> = {
  'a0-11-a': {
    ...
    steps:[
      ...
      { id:'a11a-d2', speaker:'Нөгөө хүн', staffCzech:'Dobře, pokračujeme.', staffMn:'За, үргэлжлүүлье.', promptMn:'Та ойлгосноо талархаж хэлээрэй.', choices:choices([['a','Děkuji.','Баярлалаа.'],['b','To je drahé.','Энэ үнэтэй байна.'],['c','Je zima.','Хүйтэн байна.']]), correctId:'a', feedbackMn:'Děkuji. = Баярлалаа.' },
    ],
  },
  'a0-11-b': {
    id:'a0-11-b-dialogue', titleMn:'Богино яриа — дахин хэлүүлэх', contextMn:'Та утсан дээр сайн ойлгоогүй байна.',
    steps:[
      { id:'a11b-d1', speaker:'Нөгөө хүн', staffCzech:'Slyšíte mě?', staffMn:'Та намайг сонсож байна уу?', promptMn:'Та сонсож байгаагаа хэлээрэй.', choices:choices([['a','Ano, slyším vás.','Тийм, би таныг сонсож байна.'],['b','Neteče voda.','Ус гарахгүй байна.'],['c','Tašku, prosím.','Уут өгнө үү.']]), correctId:'a', feedbackMn:'Ano, slyším vás. = Тийм, би таныг сонсож байна.' },
      { id:'a11b-d2', speaker:'Нөгөө хүн', staffCzech:'Řeknu vám informace.', staffMn:'Би танд мэдээлэл хэлье.', promptMn:'Та дахин хэлүүлэх хүсэлт тавиарай.', choices:choices([['a','Ještě jednou, prosím.','Дахиад нэг удаа хэлнэ үү.'],['b','Mám teplotu.','Би халуурч байна.'],['c','Účtenku, prosím.','Баримт өгнө үү.']]), correctId:'a', feedbackMn:'Ойлгоогүй үед Ještě jednou, prosím. гэж хэлнэ.' },
    ],
  },
  'a0-11-c': {
    ...
    steps:[
      ...
      { id:'a11c-d2', speaker:'Нөгөө хүн', staffCzech:'Dobře, napíšu vám to.', staffMn:'За, би танд бичиж өгье.', promptMn:'Та талархаарай.', choices:choices([['a','Děkuji.','Баярлалаа.'],['b','Bolí mě břicho.','Миний гэдэс өвдөж байна.'],['c','Mám klíč.','Надад түлхүүр байна.']]), correctId:'a', feedbackMn:'Děkuji. = Баярлалаа.' },
    ],
  },
  'a0-11-d': {
    ...
    steps:[
      ...
      { id:'a11d-d2', speaker:'Нөгөө хүн', staffCzech:'Dobře, pošlu SMS.', staffMn:'За, би SMS явуулъя.', promptMn:'Та талархаарай.', choices:choices([['a','Děkuji.','Баярлалаа.'],['b','Tohle, prosím.','Үүнийг авъя.'],['c','Neteče voda.','Ус гарахгүй байна.']]), correctId:'a', feedbackMn:'Яриаг Děkuji. гэж хаана.' },
    ],
  },
};
...
export const a0PhoneFinalDialogue: DialogueScenario = {
  ...
  steps:[
    ...
    { id:'a11final-d4', speaker:'Нөгөө хүн', staffCzech:'Řeknu vám informace.', staffMn:'Би танд мэдээлэл хэлье.', promptMn:'Та ойлгохгүй байгаагаа хэлээрэй.', choices:choices([['a','Nerozumím.','Би ойлгохгүй байна.'],['b','To je drahé.','Энэ үнэтэй байна.'],['c','Mám teplotu.','Би халуурч байна.']]), correctId:'a', feedbackMn:'Нэг үгээр ч гэсэн Nerozumím. гэж хэлээд яриаг зогсоож болно.' },
    ...
    { id:'a11final-d7', speaker:'Нөгөө хүн', staffCzech:'Ano, zopakuji to.', staffMn:'Тийм, би давтаж хэлье.', promptMn:'Та мэдээллийг бичүүлж авахыг хүсээрэй.', choices:choices([['a','Napište mi to, prosím.','Үүнийг надад бичээд өгнө үү.'],['b','Děkuji. Na shledanou.','Баярлалаа. Баяртай.'],['c','Potřebuji bundu.','Надад хүрэм хэрэгтэй.']]), correctId:'a', feedbackMn:'Мэдээлэл урт бол Napište mi to, prosím. гэж хэлнэ.' },
    { id:'a11final-d8', speaker:'Нөгөө хүн', staffCzech:'Můžu poslat SMS.', staffMn:'SMS явуулж болно.', promptMn:'Та SMS явуулахыг хүсээд яриаг хаагаарай.', choices:choices([['a','Pošlete mi SMS, prosím. Děkuji. Na shledanou.','Надад SMS явуулна уу. Баярлалаа. Баяртай.'],['b','Účtenku, prosím.','Баримт өгнө үү.'],['c','Neteče voda.','Ус гарахгүй байна.']]), correctId:'a', feedbackMn:'Урт мэдээллийг SMS-ээр авах хүсэлт бол A0.11-ийн гол survival phrase.' },
  ],
};
