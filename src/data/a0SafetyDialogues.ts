...
export const a0SafetyFinalDialogue: DialogueScenario = {
  ...
  steps:[
    { id:'a14final-d1', speaker:'Та', staffCzech:'Co se stalo?', staffMn:'Юу болсон бэ?', promptMn:'Та яаралтай тусламж гуйгаарай.', choices:choices([['a','Pomoc!','Туслаарай!'],['b','Dnes je zima.','Өнөөдөр хүйтэн байна.'],['c','Mám rodinu.','Би гэр бүлтэй.']]), correctId:'a', feedbackMn:'Яаралтай үед Pomoc! гэж хэлнэ.' },
    ...
    { id:'a14final-d7', speaker:'Нөгөө хүн', staffCzech:'Sanitka?', staffMn:'Түргэн тусламж уу?', promptMn:'Та түргэн тусламж дуудаж өгөхийг хүсээрэй.', choices:choices([['a','Ano, zavolejte prosím sanitku.','Тийм, түргэн тусламж дуудаж өгнө үү.'],['b','Ano, účtenku, prosím.','Тийм, баримт өгнө үү.'],['c','Ano, mám klíč.','Тийм, надад түлхүүр байна.']]), correctId:'a', feedbackMn:'Түргэн тусламж хэрэгтэй бол sanitka гэдэг үг хэрэглэнэ.' },
