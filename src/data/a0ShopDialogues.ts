...
export const a0ShopMicroDialogues: Record<string, DialogueScenario> = {
  'a0-8-a': {
    ...
    steps:[
      { id:'a08a-d1', speaker:'Ажилтан', staffCzech:'Chcete tašku?', staffMn:'Уут авах уу?', promptMn:'Та уут авна гэж хариулаарай.', choices:choices([['a','Ne, děkuji.','Үгүй, баярлалаа.'],['b','Ano, tašku, prosím.','Тийм, уут өгнө үү.'],['c','Kdy končíme?','Бид хэзээ тарах вэ?']]), correctId:'b', feedbackMn:'Уут авах бол Ano, tašku, prosím. гэж хариулна.' },
      { id:'a08a-d2', speaker:'Ажилтан', staffCzech:'Dobře. Ještě něco?', staffMn:'За. Өөр зүйл авах уу?', promptMn:'Та өөр зүйл авахгүй гэж эелдгээр хариулаарай.', choices:choices([['a','Ne, děkuji.','Үгүй, баярлалаа.'],['b','Tašku, prosím.','Уут өгнө үү.'],['c','Dám si polévku.','Би шөл авъя.']]), correctId:'a', feedbackMn:'Өөр зүйл авахгүй бол Ne, děkuji. гэж хэлнэ.' },
    ],
  },
  'a0-8-b': {
    id:'a0-8-b-dialogue', titleMn:'Богино яриа — баримт хүсэх', contextMn:'Та худалдан авалтын баримт авах гэж байна.',
    steps:[
      { id:'a08b-d1', speaker:'Ажилтан', staffCzech:'Chcete účtenku?', staffMn:'Баримт авах уу?', promptMn:'Та баримт авна гэж хариулаарай.', choices:choices([['a','S sebou, prosím.','Авч явна, гуйя.'],['b','Jdu na nádraží.','Би галт тэрэгний буудал руу явж байна.'],['c','Ano, účtenku, prosím.','Тийм, баримт өгнө үү.']]), correctId:'c', feedbackMn:'Баримт авах бол Ano, účtenku, prosím. гэж хариулна.' },
...
export const a0ShopFinalDialogue: DialogueScenario = {
  ...
  steps:[
    ...
    { id:'a08final-d2', speaker:'Ажилтан', staffCzech:'Dobře. Ještě něco?', staffMn:'За. Өөр зүйл авах уу?', promptMn:'Та үнийг асуугаарай.', choices:choices([['a','Kolik to stojí?','Энэ хэд вэ?'],['b','Kdy končíme?','Бид хэзээ тарах вэ?'],['c','S sebou, prosím.','Авч явна, гуйя.']]), correctId:'a', feedbackMn:'Үнэ асуухдаа Kolik to stojí? гэж хэлнэ.' },
    { id:'a08final-d3', speaker:'Ажилтан', staffCzech:'Chcete tašku?', staffMn:'Уут авах уу?', promptMn:'Та уут авна гэж хариулаарай.', choices:choices([['a','Ne, děkuji.','Үгүй, баярлалаа.'],['b','Dám si kávu.','Би кофе авъя.'],['c','Ano, tašku, prosím.','Тийм, уут өгнө үү.']]), correctId:'c', feedbackMn:'Уут авах бол Ano, tašku, prosím. гэж хариулна.' },
    { id:'a08final-d4', speaker:'Ажилтан', staffCzech:'Platíte kartou, nebo hotově?', staffMn:'Та картаар төлөх үү, бэлнээр төлөх үү?', promptMn:'Та картаар төлнө гэж хэлээрэй.', choices:choices([['a','Platím kartou.','Би картаар төлнө.'],['b','Platím hotově.','Би бэлнээр төлнө.'],['c','Nemám čas.','Би завгүй.']]), correctId:'a', feedbackMn:'Картаар төлөхдөө Platím kartou. гэж хариулж болно.' },
    { id:'a08final-d5', speaker:'Ажилтан', staffCzech:'Chcete účtenku?', staffMn:'Баримт авах уу?', promptMn:'Та баримт авна гэж хариулаарай.', choices:choices([['a','Ne, nemám kartu.','Үгүй, надад карт байхгүй.'],['b','Ano, účtenku, prosím.','Тийм, баримт өгнө үү.'],['c','To je drahé.','Энэ үнэтэй байна.']]), correctId:'b', feedbackMn:'Баримт авах бол Ano, účtenku, prosím. гэж хариулна.' },
