...
export const a0TimeMicroLessons: A0MicroLesson[] = [
  {
    id:'a0-5-a', titleMn:'1/4 — Цаг хэд болж байна?', canDoMn:'Цаг асууж, “одоо” гэсэн утгыг ойлгож чадна.',
    cardIds:['a0c0072','a0c0073','a0c0074'],
    instructions:{
  ...
  },
  {
    ...
    instructions:{
      a0c0075:'dnes = өнөөдөр.',
      a0c0076:'zítra = маргааш.',
      a0c0077:'ráno = өглөө.',
      a0c0078:'večer = орой.',
    },
    exercises:[
  ...
  },
  {
    ...
    instructions:{
      a0c0079:'Kdy? = Хэзээ?',
      a0c0080:'Kdy máte čas? = Та хэзээ завтай вэ?',
      a0c0081:'Mám čas. = Би завтай.',
      a0c0082:'Nemám čas. = Би завгүй.',
    },
    exercises:[
  ...
  },
  {
    ...
    cardIds:['a0c0083','a0c0084','a0c0085'],
    instructions:{
      a0c0083:'v osm = найман цагт.',
      a0c0084:'schůzka = уулзалт.',
      a0c0085:'Máme schůzku v osm. = Бид найман цагт уулзалттай.',
    },
    exercises:[
      { id:'a0-5-d-1', type:'choice', titleMn:'Цаг таних', promptMn:'v osm ямар утгатай вэ?', choices:[{id:'a',text:'найман цагт'},{id:'b',text:'өнөө орой'},{id:'c',text:'маргааш'}], correctId:'a', feedbackMn:'v osm = найман цагт.' },
