...
export const a0TimeMicroDialogues: Record<string, DialogueScenario> = {
  ...
  'a0-5-b': {
    ...
    steps:[
      { id:'a05b-d1', speaker:'Найз', staffCzech:'Máte čas dnes, nebo zítra?', staffMn:'Та өнөөдөр завтай юу, маргааш уу?', promptMn:'Та маргааш орой завтайгаа хэлээрэй.', choices:choices([['a','Zítra večer mám čas.','Маргааш орой би завтай.'],['b','Dnes ráno.','Өнөөдөр өглөө.'],['c','Teď nemám čas.','Би одоо завгүй.']]), correctId:'a', feedbackMn:'Zítra večer mám čas. = Маргааш орой би завтай.' },
      { id:'a05b-d2', speaker:'Найз', staffCzech:'Dobře. Večer?', staffMn:'За. Орой юу?', promptMn:'Та орой гэдгээ батлаарай.', choices:choices([['a','Ano, večer.','Тийм, орой.'],['b','Ne, ráno.','Үгүй, өглөө.'],['c','Teď.','Одоо.']]), correctId:'a', feedbackMn:'Орой гэдгийг богиноор Ano, večer. гэж баталж болно.' },
    ],
  },
  'a0-5-c': {
    ...
    steps:[
      ...
      { id:'a05c-d2', speaker:'Найз', staffCzech:'A zítra večer?', staffMn:'Тэгвэл маргааш орой яах вэ?', promptMn:'Та маргааш орой завтай гэдгээ хэлээрэй.', choices:choices([['a','Zítra večer mám čas.','Маргааш орой би завтай.'],['b','Nemám čas.','Би завгүй.'],['c','Ráno.','Өглөө.']]), correctId:'a', feedbackMn:'Zítra večer mám čas. = Маргааш орой би завтай.' },
    ],
  },
  'a0-5-d': {
...
export const a0TimeFinalDialogue: DialogueScenario = {
  ...
  steps:[
    ...
    { id:'a05final-d2', speaker:'Лена', staffCzech:'Kdy máte čas?', staffMn:'Та хэзээ завтай вэ?', promptMn:'Та маргааш орой завтайгаа хэлээрэй.', choices:choices([['a','Zítra večer mám čas.','Маргааш орой би завтай.'],['b','Dnes ráno.','Өнөөдөр өглөө.'],['c','Teď nemám čas.','Би одоо завгүй.']]), correctId:'a', feedbackMn:'zítra + večer = маргааш орой.' },
    ...
    { id:'a05final-d5', speaker:'Лена', staffCzech:'Na shledanou.', staffMn:'Баяртай.', promptMn:'Та яриаг албан хэлбэрээр дуусгаарай.', choices:choices([['a','Na shledanou.','Баяртай.'],['b','Ahoj.','Сайн уу.'],['c','Ne.','Үгүй.']]), correctId:'a', feedbackMn:'Na shledanou. = Албан болон саармаг баяртай.' },
  ],
};
