...
export const a0WeatherMicroDialogues: Record<string, DialogueScenario> = {
  'a0-13-a': {
    ...
    steps:[
      ...
      { id:'a13a-d2', speaker:'Нөгөө хүн', staffCzech:'A dnes je teplo?', staffMn:'Харин өнөөдөр дулаахан байна уу?', promptMn:'Та өнөөдөр дулаахан байгааг хэлээрэй.', choices:choices([['a','Dnes je teplo.','Өнөөдөр дулаахан байна.'],['b','Pomoc!','Туслаарай!'],['c','Nemám klíč.','Надад түлхүүр байхгүй.']]), correctId:'a', feedbackMn:'Dnes je teplo. = Өнөөдөр дулаахан байна.' },
    ],
  },
  'a0-13-b': {
    id:'a0-13-b-dialogue', titleMn:'Богино яриа — бороо, цас', contextMn:'Та гадаа юу болж байгааг хэлж байна.',
    steps:[
      { id:'a13b-d1', speaker:'Нөгөө хүн', staffCzech:'Co se děje venku?', staffMn:'Гадаа юу болж байна?', promptMn:'Та бороо орж байгааг хэлээрэй.', choices:choices([['a','Prší.','Бороо орж байна.'],['b','Sněží.','Цас орж байна.'],['c','Jsem nový.','Би шинэ хүн.']]), correctId:'a', feedbackMn:'Prší. = Бороо орж байна.' },
      { id:'a13b-d2', speaker:'Нөгөө хүн', staffCzech:'A teď sněží?', staffMn:'Одоо цас орж байна уу?', promptMn:'Та цас орж байгааг хэлээрэй.', choices:choices([['a','Sněží.','Цас орж байна.'],['b','Prší.','Бороо орж байна.'],['c','Děkuji.','Баярлалаа.']]), correctId:'a', feedbackMn:'Sněží. = Цас орж байна.' },
    ],
  },
  'a0-13-c': {
  ...
  'a0-13-d': {
    ...
    steps:[
      { id:'a13d-d1', speaker:'Нөгөө хүн', staffCzech:'Prší a je zima.', staffMn:'Бороо орж, хүйтэн байна.', promptMn:'Та хүрэм хэрэгтэйгээ хэлээрэй.', choices:choices([['a','Potřebuji bundu.','Надад хүрэм хэрэгтэй.'],['b','Potřebuji čepici.','Надад малгай хэрэгтэй.'],['c','Mám rodinu.','Би гэр бүлтэй.']]), correctId:'a', feedbackMn:'Бороо, хүйтэн үед Potřebuji bundu. гэж хэлж болно.' },
      { id:'a13d-d2', speaker:'Нөгөө хүн', staffCzech:'Potřebujete čepici?', staffMn:'Танд малгай хэрэгтэй юу?', promptMn:'Та малгай хэрэгтэйгээ хэлээрэй.', choices:choices([['a','Potřebuji čepici.','Надад малгай хэрэгтэй.'],['b','Zavolejte prosím policii.','Цагдаа дуудаж өгнө үү.'],['c','Napište mi to, prosím.','Үүнийг надад бичээд өгнө үү.']]), correctId:'a', feedbackMn:'Potřebuji čepici. = Надад малгай хэрэгтэй.' },
    ],
  },
};
...
export const a0WeatherFinalDialogue: DialogueScenario = {
  ...
  steps:[
    ...
    { id:'a13final-d5', speaker:'Нөгөө хүн', staffCzech:'Potřebujete čepici?', staffMn:'Танд малгай хэрэгтэй юу?', promptMn:'Та малгай хэрэгтэйгээ хэлээрэй.', choices:choices([['a','Potřebuji čepici.','Надад малгай хэрэгтэй.'],['b','Tašku, prosím.','Уут өгнө үү.'],['c','Účtenku, prosím.','Баримт өгнө үү.']]), correctId:'a', feedbackMn:'Potřebuji čepici. = Надад малгай хэрэгтэй.' },
