...
export const lessons: Lesson[] = [
  ...
  { id:'l005', title:'A0.5 Time', titleMn:'A0.5 — Цаг, өдөр, уулзалт', description:'Цаг асуух, өдөр болон уулзалтын цагийг тодруулах', wordCount:16, estimatedMinutes:32, icon:'⏰', order:5, isLocked:true, status:'ready' },
