    ...
    <div style={{ background:'#0C0C0E', minHeight:'100vh', fontFamily:'Inter,sans-serif' }}>
      <div style={{ padding:'20px 20px 0' }}>
        ...
        <div style={{ background:'#1C1C1F', borderRadius:20, padding:'16px 16px 8px', border:'1px solid #2A2A2F', marginBottom:16 }}>
          ...
          <div style={{ height:100 }}><ResponsiveContainer width="100%" height="100%"><AreaChart data={weekData}><defs><linearGradient id="gg" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#C8952A" stopOpacity={.25}/><stop offset="95%" stopColor="#C8952A" stopOpacity={0}/></linearGradient></defs><XAxis dataKey="d" tick={{ fill:'#606068', fontSize:10 }} axisLine={false} tickLine={false}/><Tooltip contentStyle={{ background:'#1C1C1F', border:'1px solid #2A2A2F', borderRadius:10, color:'#FFF', fontSize:11 }} formatter={(value) => [`${value ?? 0} XP`, ''] as [string, string]} /><Area type="monotone" dataKey="xp" stroke="#C8952A" strokeWidth={2} fill="url(#gg)" dot={{ fill:'#C8952A', r:3, strokeWidth:0 }} activeDot={{ r:5, fill:'#F5C842', stroke:'#000', strokeWidth:2 }} /></AreaChart></ResponsiveContainer></div>
        </div>
