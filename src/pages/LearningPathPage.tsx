  ...
  return (
    <div style={{ background: '#0C0C0E', minHeight: '100vh', fontFamily: 'Inter,sans-serif' }}>
      <div style={{ background: '#141416', padding: '20px 20px 16px', borderBottom: '1px solid #2A2A2F' }}>
        ...
        <p style={{ fontSize: 12, color: '#A0A0A8', marginBottom: 10, paddingLeft: 46 }}>{introducedWords.length}/{total} карттай танилцсан · {progress.learnedWords.length} карт баттай</p>
        <ProgressBar value={introducedWords.length} max={Math.max(total, 1)} height={6} showPct />
      </div>
